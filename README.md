# `aws_c_http_jq_jll.jl` (v0.10.8+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/0e4ba9f6cb47e8b44286006cb1f8790ac57648a5/A/aws_c_http_jq/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/quinnj/aws-c-http.git (revision: `c9e62e6c90882da912b4a07455df93ab8bf9a418`)
