# `aws_c_http_jq_jll.jl` (v0.10.4+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/ca68ef0decec1a1fcbffb31a525751ebdd38461a/A/aws_c_http_jq/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/quinnj/aws-c-http.git (revision: `ce0d65623bff28f03204756d9d1b3366bd0b387d`)
